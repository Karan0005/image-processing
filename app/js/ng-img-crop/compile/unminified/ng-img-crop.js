 ...
 * replace line number 1407 by var minCanvasDims=[400,400], maxCanvasDims=[800,800];
 * Then replace line number 1464 by elCanvas.prop('width',canvasDims[0]).prop('height',canvasDims[1]).css({'margin-left':     0+'px', 'margin-top': 0+'px'});
 * Change Perform on line 1598
 * Change Perform on line 1823 New Event Created;
 */
(function() {
'use strict';
